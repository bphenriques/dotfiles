# All credits go to https://github.com/NixOS/nixpkgs/pull/372184. Remove this overlay once merged.
{
  lib,
  buildNpmPackage,
  fetchFromGitHub,
...
buildNpmPackage rec {
  ...
  npmDepsHash = "sha256-fqt/VvMoQsKDN50QO6bz6Di1CqA0NdY7FcEQ6Uo2irU=";
